...
struct S2C_RiftStepExecutedMsg;
struct S2C_RiftStepExecutedMsgBuilder;
struct S2C_RiftStepExecutedMsgT;
...
enum CombatEventType : int8_t {
  CombatEventType_DamageDealt = 0,
  CombatEventType_HealReceived = 1,
  CombatEventType_Miss = 2,
  CombatEventType_Dodge = 3,
  CombatEventType_Block = 4,
  CombatEventType_Parry = 5,
  CombatEventType_CriticalHit = 6,
  CombatEventType_AbilityInterrupt = 7,
  CombatEventType_MIN = CombatEventType_DamageDealt,
  CombatEventType_MAX = CombatEventType_AbilityInterrupt
};

inline const CombatEventType (&EnumValuesCombatEventType())[8] {
...
inline const char *EnumNameCombatEventType(CombatEventType e) {
  if (::flatbuffers::IsOutRange(e, CombatEventType_DamageDealt, CombatEventType_AbilityInterrupt)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCombatEventType()[index];
}

enum RiftStepEffectPayload : uint8_t {
...
bool VerifyRiftStepEffectPayloadVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types);

enum CombatEventPayload : uint8_t {
...
bool VerifyCombatEventPayloadVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types);

enum S2C_UDP_Payload : uint8_t {
  S2C_UDP_Payload_NONE = 0,
  S2C_UDP_Payload_EntityStateUpdate = 1,
  S2C_UDP_Payload_RiftStepExecuted = 2,
  S2C_UDP_Payload_ResourceUpdate = 3,
  S2C_UDP_Payload_CombatEvent = 4,
  S2C_UDP_Payload_Pong = 5,
  S2C_UDP_Payload_MIN = S2C_UDP_Payload_NONE,
  S2C_UDP_Payload_MAX = S2C_UDP_Payload_Pong
};

inline const S2C_UDP_Payload (&EnumValuesS2C_UDP_Payload())[6] {
  static const S2C_UDP_Payload values[] = {
    S2C_UDP_Payload_NONE,
    S2C_UDP_Payload_EntityStateUpdate,
    S2C_UDP_Payload_RiftStepExecuted,
...
inline const char *EnumNameS2C_UDP_Payload(S2C_UDP_Payload e) {
  if (::flatbuffers::IsOutRange(e, S2C_UDP_Payload_NONE, S2C_UDP_Payload_Pong)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct S2C_UDP_PayloadTraits<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg> {
  static const S2C_UDP_Payload enum_value = S2C_UDP_Payload_RiftStepExecuted;
};
...
template<> struct S2C_UDP_PayloadUnionTraits<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT> {
  static const S2C_UDP_Payload enum_value = S2C_UDP_Payload_RiftStepExecuted;
};
...
struct S2C_UDP_PayloadUnion {
  ...
  RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *AsRiftStepExecuted() {
    return type == S2C_UDP_Payload_RiftStepExecuted ?
      reinterpret_cast<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *>(value) : nullptr;
  }
  const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *AsRiftStepExecuted() const {
    return type == S2C_UDP_Payload_RiftStepExecuted ?
      reinterpret_cast<const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *>(value) : nullptr;
  }
...
struct S2C_RiftStepExecutedMsgT : public ::flatbuffers::NativeTable {
  typedef S2C_RiftStepExecutedMsg TableType;
  uint64_t instigator_entity_id = 0;
  std::unique_ptr<RiftForged::Networking::Shared::Vec3> actual_start_position{};
  std::unique_ptr<RiftForged::Networking::Shared::Vec3> actual_end_position{};
  ...
  S2C_RiftStepExecutedMsgT() = default;
  S2C_RiftStepExecutedMsgT(const S2C_RiftStepExecutedMsgT &o);
  S2C_RiftStepExecutedMsgT(S2C_RiftStepExecutedMsgT&&) FLATBUFFERS_NOEXCEPT = default;
  S2C_RiftStepExecutedMsgT &operator=(S2C_RiftStepExecutedMsgT o) FLATBUFFERS_NOEXCEPT;
};

struct S2C_RiftStepExecutedMsg FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef S2C_RiftStepExecutedMsgT NativeTableType;
  typedef S2C_RiftStepExecutedMsgBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_INSTIGATOR_ENTITY_ID = 4,
    VT_ACTUAL_START_POSITION = 6,
    VT_ACTUAL_END_POSITION = 8,
    VT_ENTRY_EFFECTS_TYPE = 10,
    VT_ENTRY_EFFECTS = 12,
    VT_EXIT_EFFECTS_TYPE = 14,
    VT_EXIT_EFFECTS = 16,
    VT_TRAVEL_VFX_ID = 18,
    VT_TRAVEL_SFX_ID = 20
  };
  ...
  const RiftForged::Networking::Shared::Vec3 *actual_end_position() const {
    return GetStruct<const RiftForged::Networking::Shared::Vec3 *>(VT_ACTUAL_END_POSITION);
  }
  const ::flatbuffers::Vector<uint8_t> *entry_effects_type() const {
    return GetPointer<const ::flatbuffers::Vector<uint8_t> *>(VT_ENTRY_EFFECTS_TYPE);
  }
  ...
  const ::flatbuffers::Vector<uint8_t> *exit_effects_type() const {
    return GetPointer<const ::flatbuffers::Vector<uint8_t> *>(VT_EXIT_EFFECTS_TYPE);
  }
  ...
  const ::flatbuffers::String *travel_sfx_id() const {
    return GetPointer<const ::flatbuffers::String *>(VT_TRAVEL_SFX_ID);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<RiftForged::Networking::Shared::Vec3>(verifier, VT_ACTUAL_END_POSITION, 4) &&
           ...
           VerifyOffset(verifier, VT_TRAVEL_SFX_ID) &&
           verifier.VerifyString(travel_sfx_id()) &&
           verifier.EndTable();
  }
  S2C_RiftStepExecutedMsgT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(S2C_RiftStepExecutedMsgT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const S2C_RiftStepExecutedMsgT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct S2C_RiftStepExecutedMsgBuilder {
  typedef S2C_RiftStepExecutedMsg Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_instigator_entity_id(uint64_t instigator_entity_id) {
    fbb_.AddElement<uint64_t>(S2C_RiftStepExecutedMsg::VT_INSTIGATOR_ENTITY_ID, instigator_entity_id, 0);
  }
  void add_actual_start_position(const RiftForged::Networking::Shared::Vec3 *actual_start_position) {
    fbb_.AddStruct(S2C_RiftStepExecutedMsg::VT_ACTUAL_START_POSITION, actual_start_position);
  }
  void add_actual_end_position(const RiftForged::Networking::Shared::Vec3 *actual_end_position) {
    fbb_.AddStruct(S2C_RiftStepExecutedMsg::VT_ACTUAL_END_POSITION, actual_end_position);
  }
  void add_entry_effects_type(::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> entry_effects_type) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_ENTRY_EFFECTS_TYPE, entry_effects_type);
  }
  void add_entry_effects(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<void>>> entry_effects) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_ENTRY_EFFECTS, entry_effects);
  }
  void add_exit_effects_type(::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> exit_effects_type) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_EXIT_EFFECTS_TYPE, exit_effects_type);
  }
  void add_exit_effects(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<void>>> exit_effects) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_EXIT_EFFECTS, exit_effects);
  }
  void add_travel_vfx_id(::flatbuffers::Offset<::flatbuffers::String> travel_vfx_id) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_TRAVEL_VFX_ID, travel_vfx_id);
  }
  void add_travel_sfx_id(::flatbuffers::Offset<::flatbuffers::String> travel_sfx_id) {
    fbb_.AddOffset(S2C_RiftStepExecutedMsg::VT_TRAVEL_SFX_ID, travel_sfx_id);
  }
  explicit S2C_RiftStepExecutedMsgBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<S2C_RiftStepExecutedMsg>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> CreateS2C_RiftStepExecutedMsg(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t instigator_entity_id = 0,
    const RiftForged::Networking::Shared::Vec3 *actual_start_position = nullptr,
    const RiftForged::Networking::Shared::Vec3 *actual_end_position = nullptr,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> entry_effects_type = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<void>>> entry_effects = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> exit_effects_type = 0,
    ...
    ::flatbuffers::Offset<::flatbuffers::String> travel_sfx_id = 0) {
  S2C_RiftStepExecutedMsgBuilder builder_(_fbb);
  builder_.add_instigator_entity_id(instigator_entity_id);
  builder_.add_travel_sfx_id(travel_sfx_id);
  ...
  builder_.add_actual_end_position(actual_end_position);
  builder_.add_actual_start_position(actual_start_position);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> CreateS2C_RiftStepExecutedMsgDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t instigator_entity_id = 0,
    const RiftForged::Networking::Shared::Vec3 *actual_start_position = nullptr,
    const RiftForged::Networking::Shared::Vec3 *actual_end_position = nullptr,
    const std::vector<uint8_t> *entry_effects_type = nullptr,
    const std::vector<::flatbuffers::Offset<void>> *entry_effects = nullptr,
    const std::vector<uint8_t> *exit_effects_type = nullptr,
    const std::vector<::flatbuffers::Offset<void>> *exit_effects = nullptr,
    const char *travel_vfx_id = nullptr,
    const char *travel_sfx_id = nullptr) {
  auto entry_effects_type__ = entry_effects_type ? _fbb.CreateVector<uint8_t>(*entry_effects_type) : 0;
  auto entry_effects__ = entry_effects ? _fbb.CreateVector<::flatbuffers::Offset<void>>(*entry_effects) : 0;
  auto exit_effects_type__ = exit_effects_type ? _fbb.CreateVector<uint8_t>(*exit_effects_type) : 0;
  ...
  auto travel_sfx_id__ = travel_sfx_id ? _fbb.CreateString(travel_sfx_id) : 0;
  return RiftForged::Networking::UDP::S2C::CreateS2C_RiftStepExecutedMsg(
      _fbb,
...
::flatbuffers::Offset<S2C_RiftStepExecutedMsg> CreateS2C_RiftStepExecutedMsg(::flatbuffers::FlatBufferBuilder &_fbb, const S2C_RiftStepExecutedMsgT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct S2C_CombatEventMsgT : public ::flatbuffers::NativeTable {
  ...
  RiftForged::Networking::UDP::S2C::CombatEventType event_type = RiftForged::Networking::UDP::S2C::CombatEventType_DamageDealt;
...
struct S2C_CombatEventMsg FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  RiftForged::Networking::UDP::S2C::CombatEventPayload event_payload_type() const {
    return static_cast<RiftForged::Networking::UDP::S2C::CombatEventPayload>(GetField<uint8_t>(VT_EVENT_PAYLOAD_TYPE, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_EVENT_PAYLOAD_TYPE, 1) &&
...
struct S2C_CombatEventMsgBuilder {
  ...
  void add_event_payload_type(RiftForged::Networking::UDP::S2C::CombatEventPayload event_payload_type) {
    fbb_.AddElement<uint8_t>(S2C_CombatEventMsg::VT_EVENT_PAYLOAD_TYPE, static_cast<uint8_t>(event_payload_type), 0);
  }
...
struct Root_S2C_UDP_Message FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg *payload_as_RiftStepExecuted() const {
    return payload_type() == RiftForged::Networking::UDP::S2C::S2C_UDP_Payload_RiftStepExecuted ? static_cast<const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg *>(payload()) : nullptr;
  }
...
template<> inline const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg *Root_S2C_UDP_Message::payload_as<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg>() const {
  return payload_as_RiftStepExecuted();
}
...
inline S2C_RiftStepExecutedMsgT::S2C_RiftStepExecutedMsgT(const S2C_RiftStepExecutedMsgT &o)
      : instigator_entity_id(o.instigator_entity_id),
        ...
        actual_end_position((o.actual_end_position) ? new RiftForged::Networking::Shared::Vec3(*o.actual_end_position) : nullptr),
        entry_effects(o.entry_effects),
        exit_effects(o.exit_effects),
        travel_vfx_id(o.travel_vfx_id),
        travel_sfx_id(o.travel_sfx_id) {
}

inline S2C_RiftStepExecutedMsgT &S2C_RiftStepExecutedMsgT::operator=(S2C_RiftStepExecutedMsgT o) FLATBUFFERS_NOEXCEPT {
  std::swap(instigator_entity_id, o.instigator_entity_id);
  std::swap(actual_start_position, o.actual_start_position);
  std::swap(actual_end_position, o.actual_end_position);
  std::swap(entry_effects, o.entry_effects);
  std::swap(exit_effects, o.exit_effects);
  std::swap(travel_vfx_id, o.travel_vfx_id);
  std::swap(travel_sfx_id, o.travel_sfx_id);
  return *this;
}

inline S2C_RiftStepExecutedMsgT *S2C_RiftStepExecutedMsg::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<S2C_RiftStepExecutedMsgT>(new S2C_RiftStepExecutedMsgT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void S2C_RiftStepExecutedMsg::UnPackTo(S2C_RiftStepExecutedMsgT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  ...
  { auto _e = actual_end_position(); if (_e) _o->actual_end_position = std::unique_ptr<RiftForged::Networking::Shared::Vec3>(new RiftForged::Networking::Shared::Vec3(*_e)); }
  ...
  { auto _e = travel_sfx_id(); if (_e) _o->travel_sfx_id = _e->str(); }
}

inline ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> S2C_RiftStepExecutedMsg::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const S2C_RiftStepExecutedMsgT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateS2C_RiftStepExecutedMsg(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<S2C_RiftStepExecutedMsg> CreateS2C_RiftStepExecutedMsg(::flatbuffers::FlatBufferBuilder &_fbb, const S2C_RiftStepExecutedMsgT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const S2C_RiftStepExecutedMsgT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  ...
  auto _actual_end_position = _o->actual_end_position ? _o->actual_end_position.get() : nullptr;
  auto _entry_effects_type = _o->entry_effects.size() ? _fbb.CreateVector<uint8_t>(_o->entry_effects.size(), [](size_t i, _VectorArgs *__va) { return static_cast<uint8_t>(__va->__o->entry_effects[i].type); }, &_va) : 0;
  ...
  auto _exit_effects_type = _o->exit_effects.size() ? _fbb.CreateVector<uint8_t>(_o->exit_effects.size(), [](size_t i, _VectorArgs *__va) { return static_cast<uint8_t>(__va->__o->exit_effects[i].type); }, &_va) : 0;
  ...
  auto _travel_sfx_id = _o->travel_sfx_id.empty() ? 0 : _fbb.CreateString(_o->travel_sfx_id);
  return RiftForged::Networking::UDP::S2C::CreateS2C_RiftStepExecutedMsg(
      _fbb,
      _instigator_entity_id,
      _actual_start_position,
      _actual_end_position,
      _entry_effects_type,
      _entry_effects,
      _exit_effects_type,
      _exit_effects,
...
inline bool VerifyRiftStepEffectPayloadVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types) {
...
inline bool VerifyCombatEventPayloadVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (::flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
...
inline bool VerifyS2C_UDP_Payload(::flatbuffers::Verifier &verifier, const void *obj, S2C_UDP_Payload type) {
  switch (type) {
    ...
    case S2C_UDP_Payload_RiftStepExecuted: {
      auto ptr = reinterpret_cast<const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsg *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline ::flatbuffers::Offset<void> S2C_UDP_PayloadUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    ...
    case S2C_UDP_Payload_RiftStepExecuted: {
      auto ptr = reinterpret_cast<const RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *>(value);
      return CreateS2C_RiftStepExecutedMsg(_fbb, ptr, _rehasher).Union();
    }
    case S2C_UDP_Payload_ResourceUpdate: {
...
inline S2C_UDP_PayloadUnion::S2C_UDP_PayloadUnion(const S2C_UDP_PayloadUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case S2C_UDP_Payload_RiftStepExecuted: {
      value = new RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT(*reinterpret_cast<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *>(u.value));
      break;
    }
    case S2C_UDP_Payload_ResourceUpdate: {
...
inline void S2C_UDP_PayloadUnion::Reset() {
  switch (type) {
    ...
    case S2C_UDP_Payload_RiftStepExecuted: {
      auto ptr = reinterpret_cast<RiftForged::Networking::UDP::S2C::S2C_RiftStepExecutedMsgT *>(value);
      delete ptr;
      break;
    }
    case S2C_UDP_Payload_ResourceUpdate: {
