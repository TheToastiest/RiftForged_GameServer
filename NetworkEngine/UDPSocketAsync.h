...
#include "INetworkIO.h"           // Definition of the interface we are implementing
#include "NetworkEndpoint.h"      // Defines NetworkEndpoint struct
#include "OverlappedIOContext.h"  // Defines OverlappedIOContext struct
