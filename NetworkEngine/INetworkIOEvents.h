...
#include "NetworkEndpoint.h" // Assuming this defines your NetworkEndpoint struct/class
#include "OverlappedIOContext.h" // UDPSocketAsync uses this, so events might pass it
#include <cstdint>
#include <string>
