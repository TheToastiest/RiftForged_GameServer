        ...
        namespace Combat {
            ...
            AttackOutcome ProcessAbilityLaunchPhysicsProjectile(
                ...
                physx::PxRigidDynamic* projectileActor = physicsEngine.CreatePhysicsProjectileActor(
                    arrowPhysProps,                                 // 1. const ProjectilePhysicsProperties& properties
                    gameData,                                       // 2. const ProjectileGameData& gameData
                    RiftForged::Physics::EPhysicsObjectType::PROJECTILE, // 3. EPhysicsObjectType projectile_type (or MAGIC_PROJECTILE, etc.)
                    projectileStartPosition,                        // 4. const RiftForged::Utilities::Math::Vec3& startPosition
                    initialVelocity,                                // 5. const RiftForged::Utilities::Math::Vec3& initialVelocity
                    nullptr                                         // 6. physx::PxMaterial* material (optional)
                );
