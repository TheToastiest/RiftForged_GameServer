...
struct C2S_RiftStepMsg;
struct C2S_RiftStepMsgBuilder;
struct C2S_RiftStepMsgT;
...
template<> struct C2S_UDP_PayloadTraits<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg> {
  static const C2S_UDP_Payload enum_value = C2S_UDP_Payload_RiftStep;
};
...
template<> struct C2S_UDP_PayloadUnionTraits<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT> {
  static const C2S_UDP_Payload enum_value = C2S_UDP_Payload_RiftStep;
};
...
struct C2S_UDP_PayloadUnion {
  ...
  RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *AsRiftStep() {
    return type == C2S_UDP_Payload_RiftStep ?
      reinterpret_cast<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *>(value) : nullptr;
  }
  const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *AsRiftStep() const {
    return type == C2S_UDP_Payload_RiftStep ?
      reinterpret_cast<const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *>(value) : nullptr;
  }
...
struct C2S_RiftStepMsgT : public ::flatbuffers::NativeTable {
  typedef C2S_RiftStepMsg TableType;
  uint64_t timestamp_ms = 0;
  std::unique_ptr<RiftForged::Networking::Shared::Vec3> target_position{};
  C2S_RiftStepMsgT() = default;
  C2S_RiftStepMsgT(const C2S_RiftStepMsgT &o);
  C2S_RiftStepMsgT(C2S_RiftStepMsgT&&) FLATBUFFERS_NOEXCEPT = default;
  C2S_RiftStepMsgT &operator=(C2S_RiftStepMsgT o) FLATBUFFERS_NOEXCEPT;
};

struct C2S_RiftStepMsg FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef C2S_RiftStepMsgT NativeTableType;
  typedef C2S_RiftStepMsgBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_TIMESTAMP_MS = 4,
  ...
  C2S_RiftStepMsgT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(C2S_RiftStepMsgT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<C2S_RiftStepMsg> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const C2S_RiftStepMsgT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct C2S_RiftStepMsgBuilder {
  typedef C2S_RiftStepMsg Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_timestamp_ms(uint64_t timestamp_ms) {
    fbb_.AddElement<uint64_t>(C2S_RiftStepMsg::VT_TIMESTAMP_MS, timestamp_ms, 0);
  }
  void add_target_position(const RiftForged::Networking::Shared::Vec3 *target_position) {
    fbb_.AddStruct(C2S_RiftStepMsg::VT_TARGET_POSITION, target_position);
  }
  explicit C2S_RiftStepMsgBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<C2S_RiftStepMsg> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<C2S_RiftStepMsg>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<C2S_RiftStepMsg> CreateC2S_RiftStepMsg(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t timestamp_ms = 0,
    const RiftForged::Networking::Shared::Vec3 *target_position = nullptr) {
  C2S_RiftStepMsgBuilder builder_(_fbb);
  builder_.add_timestamp_ms(timestamp_ms);
  builder_.add_target_position(target_position);
  return builder_.Finish();
}

::flatbuffers::Offset<C2S_RiftStepMsg> CreateC2S_RiftStepMsg(::flatbuffers::FlatBufferBuilder &_fbb, const C2S_RiftStepMsgT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct Root_C2S_UDP_Message FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg *payload_as_RiftStep() const {
    return payload_type() == RiftForged::Networking::UDP::C2S::C2S_UDP_Payload_RiftStep ? static_cast<const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg *>(payload()) : nullptr;
  }
...
template<> inline const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg *Root_C2S_UDP_Message::payload_as<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg>() const {
  return payload_as_RiftStep();
}
...
inline C2S_RiftStepMsgT::C2S_RiftStepMsgT(const C2S_RiftStepMsgT &o)
      : timestamp_ms(o.timestamp_ms),
        target_position((o.target_position) ? new RiftForged::Networking::Shared::Vec3(*o.target_position) : nullptr) {
}

inline C2S_RiftStepMsgT &C2S_RiftStepMsgT::operator=(C2S_RiftStepMsgT o) FLATBUFFERS_NOEXCEPT {
  std::swap(timestamp_ms, o.timestamp_ms);
  std::swap(target_position, o.target_position);
  return *this;
}

inline C2S_RiftStepMsgT *C2S_RiftStepMsg::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<C2S_RiftStepMsgT>(new C2S_RiftStepMsgT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void C2S_RiftStepMsg::UnPackTo(C2S_RiftStepMsgT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = timestamp_ms(); _o->timestamp_ms = _e; }
...
inline ::flatbuffers::Offset<C2S_RiftStepMsg> C2S_RiftStepMsg::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const C2S_RiftStepMsgT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateC2S_RiftStepMsg(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<C2S_RiftStepMsg> CreateC2S_RiftStepMsg(::flatbuffers::FlatBufferBuilder &_fbb, const C2S_RiftStepMsgT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const C2S_RiftStepMsgT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _timestamp_ms = _o->timestamp_ms;
  auto _target_position = _o->target_position ? _o->target_position.get() : nullptr;
  return RiftForged::Networking::UDP::C2S::CreateC2S_RiftStepMsg(
      _fbb,
      _timestamp_ms,
      _target_position);
}
...
inline bool VerifyC2S_UDP_Payload(::flatbuffers::Verifier &verifier, const void *obj, C2S_UDP_Payload type) {
  switch (type) {
    ...
    case C2S_UDP_Payload_RiftStep: {
      auto ptr = reinterpret_cast<const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsg *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline ::flatbuffers::Offset<void> C2S_UDP_PayloadUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    ...
    case C2S_UDP_Payload_RiftStep: {
      auto ptr = reinterpret_cast<const RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *>(value);
      return CreateC2S_RiftStepMsg(_fbb, ptr, _rehasher).Union();
    }
    case C2S_UDP_Payload_UseAbility: {
...
inline C2S_UDP_PayloadUnion::C2S_UDP_PayloadUnion(const C2S_UDP_PayloadUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case C2S_UDP_Payload_RiftStep: {
      value = new RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT(*reinterpret_cast<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *>(u.value));
      break;
    }
    case C2S_UDP_Payload_UseAbility: {
...
inline void C2S_UDP_PayloadUnion::Reset() {
  switch (type) {
    ...
    case C2S_UDP_Payload_RiftStep: {
      auto ptr = reinterpret_cast<RiftForged::Networking::UDP::C2S::C2S_RiftStepMsgT *>(value);
      delete ptr;
      break;
    }
    case C2S_UDP_Payload_UseAbility: {
